...
console.log('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: populatedb mongodb+srv://Sakhr:freeze321!@cluster0-mbdj7.mongodb.net/local_library?retryWrites=true');
...
function genreCreate(genreCategory, cb) {
    genredetail = { genreCategory:genreCategory }
